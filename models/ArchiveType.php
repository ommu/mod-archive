 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_archive_type".
 *
 * The followings are the available columns in table 'ommu_archive_type':
 ...
 * @property ArchiveLists[] $ArchiveLists
 */
class ArchiveType extends CActiveRecord
{
	 ...
	 * @return ArchiveType the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('publish, type_name, type_code', 'required'),
			array('publish', 'numerical', 'integerOnly'=>true),
			array('type_name', 'length', 'max'=>32),
			array('type_code', 'length', 'max'=>8),
	...
	public function relations()
	{
		...
		return array(
			...
			'lists' => array(self::HAS_MANY, 'ArchiveLists', 'type_id', 'on'=>'lists.publish = 1'),
			'list_unpublish' => array(self::HAS_MANY, 'ArchiveLists', 'type_id', 'on'=>'list_unpublish.publish = 0'),
			'list_all' => array(self::HAS_MANY, 'ArchiveLists', 'type_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('t.type_name', strtolower($this->type_name), true);
		$criteria->compare('t.type_desc', strtolower($this->type_desc), true);
		...
		if(!Yii::app()->getRequest()->getParam('ArchiveType_sort'))
