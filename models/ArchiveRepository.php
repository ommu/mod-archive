 ...
 * @property ArchiveRepositoryGrid $grid
...
class ArchiveRepository extends \app\components\ActiveRecord
{
	...
	{
		return $this->hasOne(ArchiveRepositoryGrid::className(), ['id' => 'id']);
	}
	...
	public function init()
	{
		...
		$this->templateColumns['oArchive'] = [
			...
			'value' => function($model, $key, $index, $column) {
				...
				return Html::a($archives, ['admin/manage', 'repositoryId' => $model->primaryKey], ['title' => Yii::t('app', '{count} senarai', ['count' => $archives]), 'data-pjax' => 0]);
			},
