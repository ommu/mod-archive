 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "_view_archive_type".
 *
 * The followings are the available columns in table '_view_archive_type':
 ...
 */
class ViewArchiveType extends CActiveRecord
{
	 ...
	 * @return ViewArchiveType the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('type_id, lists, list_all, copies, copy_all, archives, archive_all, archive_pages, archive_page_all', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		if(!Yii::app()->getRequest()->getParam('ViewArchiveType_sort'))
