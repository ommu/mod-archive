 ...
 * ArchiveMedia
 *
 * ArchiveMedia represents the model behind the search form about `ommu\archive\models\ArchiveMedia`.
 *
...
use ommu\archive\models\ArchiveMedia as ArchiveMediaModel;

class ArchiveMedia extends ArchiveMediaModel
{
	/**
	 * {@inheritdoc}
	 */
	...
	public function search($params, $column=null)
	{
		...
		$query->andFilterWhere([
			't.id' => $this->id,
			't.media_name' => $this->media_name,
			't.media_desc' => $this->media_desc,
		...
		$query->andFilterWhere(['like', 'title.message', $this->media_name_i])
			->andFilterWhere(['like', 'description.message', $this->media_desc_i])
