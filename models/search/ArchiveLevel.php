 ...
 * ArchiveLevel
 *
 * ArchiveLevel represents the model behind the search form about `ommu\archive\models\ArchiveLevel`.
 *
...
use ommu\archive\models\ArchiveLevel as ArchiveLevelModel;

class ArchiveLevel extends ArchiveLevelModel
{
	/**
	 * {@inheritdoc}
	 */
