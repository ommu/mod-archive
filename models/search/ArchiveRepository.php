 ...
 * ArchiveRepository
 *
 * ArchiveRepository represents the model behind the search form about `ommu\archive\models\ArchiveRepository`.
 *
...
use ommu\archive\models\ArchiveRepository as ArchiveRepositoryModel;

class ArchiveRepository extends ArchiveRepositoryModel
{
	/**
	 * {@inheritdoc}
	 */
	...
	public function search($params, $column=null)
	{
		...
		$query->andFilterWhere(['like', 't.repository_name', $this->repository_name])
			->andFilterWhere(['like', 't.repository_desc', $this->repository_desc])
