...
class StoryController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		$setting = ArchiveStory::model()->findByPk(1,array(
		...
		$dataProvider = new CActiveDataProvider('ArchiveStory', array(
			'criteria'=>$criteria,
			'pagination'=>array(
				'pageSize'=>10,
			),
		...
		$this->pageTitle = Yii::t('phrase', 'Archive Stories');
	...
	{
		$model=new ArchiveStory;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['ArchiveStory'])) {
			$model->attributes=$_POST['ArchiveStory'];
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'ArchiveStory success created.'));
	...
	public function actionEdit($id) 
	{
		...
		if(isset($_POST['ArchiveStory'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'ArchiveStory success updated.'));
					//$this->redirect(array('view','id'=>$model->story_id));
					$this->redirect(array('manage'));
				}
			}
	...
	public function actionRunAction() {
		...
		if(count($id) > 0) {
			...
			if($actions == 'publish') {
				ArchiveStory::model()->updateAll(array(
					'publish' => 1,
				),$criteria);
				...
				ArchiveStory::model()->deleteAll($criteria);
			}
		}
	...
	{
		$model = ArchiveStory::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='archive-story-form') {
