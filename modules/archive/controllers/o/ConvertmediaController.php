...
class ConvertmediaController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		$setting = ArchiveConvertMedia::model()->findByPk(1,array(
		...
		$dataProvider = new CActiveDataProvider('ArchiveConvertMedia', array(
			'criteria'=>$criteria,
			'pagination'=>array(
				'pageSize'=>10,
			),
		...
		$this->pageTitle = Yii::t('phrase', 'Archive Convert Medias');
		$this->pageDescription = $setting->meta_description;
		$this->pageMeta = $setting->meta_keyword;
		$this->render('/convert_media/front_index',array(
	...
	public function actionView($id) 
	{
		...
		$this->pageMeta = $setting->meta_keyword;
		$this->render('/convert_media/front_view',array(
			'model'=>$model,
		));
		/*
		$this->render('/convert_media/admin_view',array(
			'model'=>$model,
		));
		*/
	}	
	...
	public function actionManage() 
	{
		...
		$this->pageDescription = '';
		$this->pageMeta = '';
		$this->render('/convert_media/admin_manage',array(
			'model'=>$model,
			'columns' => $columns,
		));
	}	
	...
	public function actionAdd() 
	{
		...
		if(isset($_POST['ArchiveConvertMedia'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'ArchiveConvertMedia success created.'));
		...
		$this->pageDescription = '';
		$this->pageMeta = '';
		$this->render('/convert_media/admin_add',array(
			'model'=>$model,
		));
	}
	...
	public function actionEdit($id) 
	{
		...
		if(isset($_POST['ArchiveConvertMedia'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'ArchiveConvertMedia success updated.'));
					//$this->redirect(array('view','id'=>$model->id));
					$this->redirect(array('manage'));
				}
			}
		...
		$this->pageDescription = '';
		$this->pageMeta = '';
		$this->render('/convert_media/admin_edit',array(
			'model'=>$model,
		));
	}
	...
	public function actionDelete($id) 
	{
		...
		if(Yii::app()->request->isPostRequest) {
			...
			$this->pageDescription = '';
			$this->pageMeta = '';
			$this->render('/convert_media/admin_delete');
		}
	}
	...
	public function actionPublish($id) 
	{
		...
		if(Yii::app()->request->isPostRequest) {
			...
			$this->pageDescription = '';
			$this->pageMeta = '';
			$this->render('/convert_media/admin_publish',array(
				'title'=>$title,
				'model'=>$model,
			));
		}
	...
	public function actionHeadline($id) 
	{
		...
		if(Yii::app()->request->isPostRequest) {
			...
			$this->pageDescription = '';
			$this->pageMeta = '';
			$this->render('/convert_media/admin_headline');
		}
	}
