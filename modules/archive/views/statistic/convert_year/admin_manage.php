...
<?php $this->renderPartial('/statistic/convert_year/_search',array(
	'model'=>$model,
)); ?>
</div>
<?php //end.Search ?>
...
<div class="grid-form">
<?php $this->renderPartial('/statistic/convert_year/_option_form',array(
	'model'=>$model,
)); ?>
</div>
<?php //end.Grid Option ?>

<div id="partial-view-archive-convert-year">
	<?php //begin.Messages ?>
	<div id="ajax-message">
	<?php
	...
	<div class="boxed">
		...
		<?php 
			...
			$this->widget('application.components.system.OGridView', array(
				'id'=>'view-archive-convert-year-grid',
