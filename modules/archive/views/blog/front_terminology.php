...
<div class="pager">
	<a href="<?php echo Yii::app()->controller->createUrl('terminology', array('url'=>urlencode($model->nextPager)));?>" title="<?php echo Yii::t('phrase', 'Loadmore');?>"><?php echo Yii::t('phrase', 'Loadmore');?></a>
</div>
<?php }?>