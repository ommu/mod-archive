<a class="title" href="<?php //echo Yii::app()->controller->createUrl('view', array('id'=>$data->convert_id,'slug'=>Utility::getUrlTitle($data->convert_title)))?>javascript:void(0);" title="<?php echo $data->convert_title?>"><?php echo Utility::shortText(Utility::hardDecode($data->convert_title),60)?></a>
