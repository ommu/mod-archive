<a class="title" href="<?php //echo Yii::app()->controller->createUrl('view', array('id'=>$data->list_id,'slug'=>Utility::getUrlTitle($data->list_title)))?>javascript:void(0);" title="<?php echo $data->list_title?>"><?php echo Utility::shortText(Utility::hardDecode($data->list_title),60)?></a>
