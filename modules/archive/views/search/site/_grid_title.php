<a class="title" href="<?php //echo Yii::app()->controller->createUrl('view', array('id'=>$data->archive_id,'slug'=>Utility::getUrlTitle($data->archive_title)))?>javascript:void(0);" title="<?php echo $data->archive_title?>"><?php echo Utility::shortText(Utility::hardDecode($data->archive_title),60)?></a>
