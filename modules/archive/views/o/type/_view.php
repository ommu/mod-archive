...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('type_desc')); ?>:</b>
	<?php echo CHtml::encode($data->type_desc); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('type_code')); ?>:</b>
	<?php echo CHtml::encode($data->type_code); ?>
	<br />
