...
<div class="field">
	...
	<?php echo $form->textField($model,"convert_number_multiple[$key][start]", array('placeholder'=>'Start', 'class'=>'span-3')); ?>
	<?php echo $form->textField($model,"convert_number_multiple[$key][finish]", array('placeholder'=>'Finish', 'class'=>'span-3')); ?>
