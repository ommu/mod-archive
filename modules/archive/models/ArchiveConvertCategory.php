 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_archive_convert_category".
 *
 * The followings are the available columns in table 'ommu_archive_convert_category':
...
class ArchiveConvertCategory extends CActiveRecord
{
	 ...
	 * @return ArchiveConvertCategory the static model class
	 */
	...
	{
		return 'ommu_archive_convert_category';
	}
	...
	public function rules()
	{
		...
		return array(
			array('category_name, category_desc, category_code, creation_date, creation_id, modified_id', 'required'),
			...
			array('category_id, publish, category_name, category_desc, category_code, creation_date, creation_id, modified_date, modified_id', 'safe', 'on'=>'search'),
		);
	}
