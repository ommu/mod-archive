...
class ArchiveStory extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('story_name, story_desc, story_code, creation_date, creation_id, modified_id', 'required'),
			...
			array('story_id, publish, story_name, story_desc, story_code, creation_date, creation_id, modified_date, modified_id', 'safe', 'on'=>'search'),
		);
	}
