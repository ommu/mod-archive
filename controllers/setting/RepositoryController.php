...
use ommu\archive\models\search\ArchiveRepository as ArchiveRepositorySearch;
...
class RepositoryController extends Controller
{
	...
	/**
	 * Lists all ArchiveRepository models.
	 * @return mixed
	 */
	public function actionManage()
	{
		$searchModel = new ArchiveRepositorySearch();
		...
		$this->view->title = Yii::t('app', 'Archival Institutions');
	...
	/**
	 * Creates a new ArchiveRepository model.
	...
	/**
	 * Updates an existing ArchiveRepository model.
	...
	/**
	 * Displays a single ArchiveRepository model.
	 * @param integer $id
	 * @return mixed
	 */
	...
	/**
	 * Deletes an existing ArchiveRepository model.
	...
	public function actionDelete($id)
	{
		...
		if($model->save(false, ['publish','modified_id'])) {
			Yii::$app->session->setFlash('success', Yii::t('app', 'Archival institution success deleted.'));
			return $this->redirect(['manage']);
		}
	}

	/**
	 * actionPublish an existing ArchiveRepository model.
	...
	/**
	 * Finds the ArchiveRepository model based on its primary key value.
	 * If the model is not found, a 404 HTTP exception will be thrown.
	 * @param integer $id
	 * @return ArchiveRepository the loaded model
	 * @throws NotFoundHttpException if the model cannot be found
	 */
	protected function findModel($id)
	{
		if(($model = ArchiveRepository::findOne($id)) !== null)
			return $model;
