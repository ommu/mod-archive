 ...
 * @created date 6 March 2019, 02:26 WIB
...
use ommu\archive\models\search\ArchiveLevel as ArchiveLevelSearch;
...
class LevelController extends Controller
{
	...
	/**
	 * Lists all ArchiveLevel models.
	 * @return mixed
	 */
	public function actionManage()
	{
        $searchModel = new ArchiveLevelSearch();
	...
	/**
	 * Creates a new ArchiveLevel model.
	...
	/**
	 * Updates an existing ArchiveLevel model.
	...
	/**
	 * Displays a single ArchiveLevel model.
	 * @param integer $id
	 * @return mixed
	 */
	...
	/**
	 * Deletes an existing ArchiveLevel model.
	...
	/**
	 * actionPublish an existing ArchiveLevel model.
	...
	/**
	 * Finds the ArchiveLevel model based on its primary key value.
	 * If the model is not found, a 404 HTTP exception will be thrown.
	 * @param integer $id
	 * @return ArchiveLevel the loaded model
