...
class m221004_202322_archive_module_createTable_ArchiveLuringGrid extends \yii\db\Migration
{
	public function up()
	{
		...
		$tableName = Yii::$app->db->tablePrefix . 'ommu_archive_luring_grid';
		if (!Yii::$app->db->getTableSchema($tableName, true)) {
			$this->createTable($tableName, [
				'id' => Schema::TYPE_INTEGER . '(11) UNSIGNED NOT NULL',
				'download' => Schema::TYPE_INTEGER . '(11) NOT NULL',
				'modified_date' => Schema::TYPE_TIMESTAMP . ' NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT \'trigger,on_update\'',
				'PRIMARY KEY ([[id]])',
				'CONSTRAINT ommu_archive_luring_grid_ibfk_1 FOREIGN KEY ([[id]]) REFERENCES ommu_archive_lurings ([[id]]) ON DELETE CASCADE ON UPDATE CASCADE',
			], $tableOptions);
		}
	}
