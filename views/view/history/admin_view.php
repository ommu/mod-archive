...
if (!$small) {
    ...
    $this->params['breadcrumbs'][] = ['label' => $model->view->archive->isFond ? Yii::t('app', 'Senarai') : Yii::t('app', 'Inventory'), 'url' => $model->view->archive->isFond ? ['fond/index'] : ['admin/index']];
    $this->params['breadcrumbs'][] = ['label' => $model->view->archive->isFond ? $model->view->archive->code : Yii::t('app', '{level-name} {code}', ['level-name' => $model->view->archive->levelTitle->message, 'code' => $model->view->archive->code]), 'url' => [($model->view->archive->isFond ? 'fond' : 'admin').'/view', 'id' => $model->view->archive_id]];
