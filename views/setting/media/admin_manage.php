 ...
 * @var $searchModel ommu\archive\models\search\ArchiveMedia
 *
...
$this->params['menu']['content'] = [
	['label' => Yii::t('app', 'Add Media'), 'url' => Url::to(['create']), 'icon' => 'plus-square', 'htmlOptions' => ['class'=>'btn btn-success btn-sm']],
];
...
<div class="archive-media-manage">
<?php Pjax::begin(); ?>
